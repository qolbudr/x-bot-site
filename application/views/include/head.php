...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url('assets/home/images/') ?>/logo-alt.png">
    <title>X-Bot - Configure your virtual assistant</title>
    <!-- Custom CSS -->
    ...
    <!-- Custom CSS -->
    <link href="<?= base_url('dist') ?>/css/prism.css" rel="stylesheet">
